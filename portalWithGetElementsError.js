...
function ContentSwitcher (ContentDivId) {
	...
	//if(ContentDivId.substr(0,5) == 'Intro') {var maindiv = 'Intro';}
	//else if(ContentDivId.substr(0,3) == 'Use') {var maindiv = 'Use';}
	//else if(ContentDivId.substr(0,4) == 'Help') {var maindiv = 'Help';
												//UpdateHelpContent();}
	
	document.getElementsByClassName('TopSection').style.backgroundColor = "#cccccc";
	document.getElementsByClassName('TopSection').style.color = "#333333";
	
	document.getElementById(maindiv + 'Top').style.backgroundColor = "#aaaaaa";
	document.getElementById(maindiv + 'Top').style.color = "#AA3F00";	
